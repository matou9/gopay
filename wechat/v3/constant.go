...
const (
    ...
    v3BaseUrlCh       = "https://apihk.mch.weixin.qq.com"  // 中国国内
    v3BaseUrlChBackup = "https://api2.mch.weixin.qq.com" // 中国国内

    v3GetCerts = "/v3/certificates"
    // 基础支付（直连模式）
    v3ApiApp                     = "/v3/global/transactions/app"                   // APP 下单
    v3ApiJsapi                   = "/v3/global/transactions/jsapi"                 // JSAPI/小程序 下单
    v3ApiNative                  = "/v3/global/transactions/native"                // Native 下单
    v3ApiH5                      = "/v3/global/transactions/h5"                    // H5 下单
    v3ApiQueryOrderTransactionId = "/v3/global/transactions/id/%s"                 // transaction_id 微信支付订单号查询订单
    v3ApiQueryOrderOutTradeNo    = "/v3/global/transactions/out-trade-no/%s"       // out_trade_no 商户订单号查询订单
    v3ApiCloseOrder              = "/v3/global/transactions/out-trade-no/%s/close" // out_trade_no 关闭订单

    // 基础支付（服务商模式）
    v3ApiPartnerPayApp                  = "/v3/global/partner/transactions/app"                   // partner APP 下单
    v3ApiPartnerJsapi                   = "/v3/global/partner/transactions/jsapi"                 // partner JSAPI 下单
    v3ApiPartnerNative                  = "/v3/global/partner/transactions/native"                // partner Native 下单
    v3ApiPartnerH5                      = "/v3/global/partner/transactions/h5"                    // partner H5 下单
    v3ApiPartnerQueryOrderTransactionId = "/v3/global/partner/transactions/id/%s"                 // partner transaction_id 查询订单
    v3ApiPartnerQueryOrderOutTradeNo    = "/v3/global/partner/transactions/out-trade-no/%s"       // partner out_trade_no 查询订单
    v3ApiPartnerCloseOrder              = "/v3/global/partner/transactions/out-trade-no/%s/close" // partner out_trade_no 关闭订单
    ...
    // 付款码支付
    v3ApiCodePay               = "/v3/global/micropay/transactions/codepay"                         // 付款码支付
    v3ApiCodePayReverse        = "/v3/global/micropay/transactions/out-trade-no/%s/reverse"         // out_trade_no 撤销
    v3ApiPartnerCodePay        = "/v3/global/partner/transactions/codepay"                 // 服务商付款码支付
    v3ApiPartnerCodePayReverse = "/v3/global/partner/transactions/out-trade-no/%s/reverse" // out_trade_no 服务商撤销

    // 退款
    v3DomesticRefund         = "/v3/global/refunds"                          // 申请退款
    v3DomesticRefundQuery    = "/v3/global/refunds/%s"                       // out_refund_no 查询单笔退款
    v3DomesticAbnormalRefund = "/v3/global/refunds/%s/apply-abnormal-refund" // refund_id 发起异常退款
    ...
    // 平台收付通（退款）
    v3CommerceRefund              = "/v3/global/refunds/apply"             // 申请退款 POST
    v3CommerceRefundQueryById     = "/v3/global/refunds/id/%s"             // refund_id 通过微信支付退款单号查询退款 GET
    v3CommerceRefundQueryByNo     = "/v3/global/refunds/out-refund-no/%s"  // out_refund_no 通过商户退款单号查询退款 GET
    v3CommerceRefundAdvance       = "/v3/global/refunds/%s/return-advance" // refund_id 垫付退款回补 POST
    v3CommerceRefundAdvanceResult = "/v3/global/refunds/%s/return-advance" // refund_id 查询垫付回补结果 GET
